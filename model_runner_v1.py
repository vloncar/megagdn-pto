        ...
        for layer_name, attn_module in attn_layers.items():
            if isinstance(attn_module, Attention):
                ...
                if self.use_sparse:
                    ...
                    # spec may be the original MLAAttentionSpec (bound in mla_attention.py
                    # before platform patch replaces the class with AscendMLAAttentionSpec)
                    # or already AscendMLAAttentionSpec. Both carry the fields used below.
                    from vllm.v1.kv_cache_interface import MLAAttentionSpec as AscendMLAAttentionSpec
